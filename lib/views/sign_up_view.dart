...
class _SignUpViewState extends State<SignUpView> {
  ...
  String _email, _password, _name, _warning, type;
    ...
    if (validate()) {
      try {
        ...
        if (authFormType == AuthFormType.signIn) {
          String uid = await auth.signInWithEmailAndPassword(_email, _password , context);
          ...
          String uid = await auth.createUserWithEmailAndPassword(
              _email, _password, _name,type, context);
    ...
    if (authFormType == AuthFormType.signUp) {
      textFields.add(
        TextFormField(
          ...
          decoration: buildSignUpInputDecoration("First Name ... Second Name ... Last Name"),
    ...
    if (authFormType == AuthFormType.signUp) {
      textFields.add(
        DropdownButtonFormField(
          ...
          hint: Text('Enter account type', style: TextStyle(color: Colors.white),),
